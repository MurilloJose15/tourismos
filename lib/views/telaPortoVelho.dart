...
class TelaPortoVelho extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    final Uri url = Uri(
        ...
        host: 'www.google.com',
        path:
            '/maps/place/Porto+Velho,+RO/@-8.7565367,-63.9373096,12z/data=!3m1!4b1!4m15!1m8!3m7!1s0x922d328ca4a88c47:0x4380950ed6230760!2sPorto+Velho+-+RO!3b1!8m2!3d-8.7635576!4d-63.8971704!16zL20vMDF6aGp4!3m5!1s0x92325b665998520b:0x75d0f25ad2c5198b!8m2!3d-8.7635475!4d-63.8971723!16s%2Fg%2F11bc5pvkw0');
    final Uri url2 =
        Uri(scheme: 'https', host: 'youtu.be', path: '/oEPOMaaekAU');
    final Uri url3 = Uri(
        scheme: 'https',
        host: 'www.tripadvisor.com.br',
        path: '/Restaurants-g737097-Porto_Velho_State_of_Rondonia.html');
    final Uri url4 = Uri(
        scheme: 'https',
        host: 'www.tripadvisor.com.br',
        path: '/Hotels-g737097-Porto_Velho_State_of_Rondonia-Hotels.html');
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            PopupMenuButton(
                tooltip: 'Menu',
                onSelected: (String value) => launchInWebViewOrVC(url),
        ...
        body: Container(
          height: largy / 2,
          margin: EdgeInsets.only(top: largy / 2.2),
